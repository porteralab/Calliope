function [data_path,ExpIDinfo]=get_data_path(ExpID,ExpIDinfo,ExpLog)
...
[~,backup_paths]=define_backup_paths(1);
...
if ~exist('ExpIDinfo','var')  || isempty(ExpIDinfo)
    ...
    stacks_ind=find(ExpLog.expid==ExpID);
...
searchlist = unique([localname;pdef.backup_destination(:); backup_paths(1,1);backup_paths(4,1);backup_paths(:,1)],'stable');

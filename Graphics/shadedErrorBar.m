...
% Marcus Leinweber 2015, minor change to bring all lines to the front
...
% in case of plotting multiple lines, bring lines to the front
temp=get(gca,'Children');
set(gca,'Children',[findobj(temp,'type','line');findobj(temp,'type','Patch')]);

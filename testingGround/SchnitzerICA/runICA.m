function [IcaFilters IcaTraces] = runICA(PcaFilters, PcaTraces, nICs, varargin)
    % runs ICA on input PCA filters/traces
    % Benjamin Grewe
    % started: 2013.10.08
    % based on SpikeE script by Jerome Lecoq
    % started 2013.02.xx by maggie carr, biafra ahanonu
    % inputs
